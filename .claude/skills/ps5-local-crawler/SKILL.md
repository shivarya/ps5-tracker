...
> ⚠️ **SUNSET (2026-08-18)** — this app is decommissioned, see [`../../../SUNSET.md`](../../../SUNSET.md). The `PS5TrackerLocalCrawler`/`PS5TrackerDevServer`/`PS5TrackerDashboard` Scheduled Tasks described below have all been deleted and the underlying processes killed — the recreation commands further down are kept as a resurrection reference only.
